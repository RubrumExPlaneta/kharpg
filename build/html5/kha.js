...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Project", width : 640, height : 480},function() {
		new Project();
	});
};
Math.__name__ = true;
...
Player.prototype = {
	keyDown: function(key) {
		if(this.movementKeys.indexOf(key) == -1 && (key == 38 || key == 40 || key == 37 || key == 39)) {
			this.movementKeys.splice(0,0,key);
		}
	}
	,keyUp: function(key) {
		HxOverrides.remove(this.movementKeys,key);
	}
	,update: function() {
		if(this.x % 16 == 0 && this.y % 16 == 0) {
			if(this.movementKeys.length > 0) {
				var _g = this.movementKeys[0];
				switch(_g) {
				case 37:
					this.yMove = 0;
...
var Project = function() {
	...
	kha_input_Keyboard.get(0).notify($bind(this,this.keyDown),$bind(this,this.keyUp));
...
Project.prototype = {
	...
	,render: function(framebuffer) {
		this.player.render(framebuffer);
	}
	,__class__: Project
};
...
Project.GRID_SIZE = 16;
Project.TILE_SIZE = 32;
